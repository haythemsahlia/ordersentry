    ...
    <div class="panel-body">
	 ...
	 <table id="myTable" class="table table-fixedheader table-bordered table-striped">
			...
			<th style="width:10%"><h4 style="margin-top:0px;"> <center><?php echo $this->Paginator->sort('id', 'ID');?>  </center></h4></th>
			 ...
			 <th style="width:11%"><h4 style="margin-top:0px;"> <center><?php echo $this->Paginator->sort('customername', 'Customer') ; ?></center></h4></th>
        ...
        {echo '<th style="width:8%"><h4 style="margin-top:0px;"> <center>Check out</center></h4></th>';} ?>
		<?php if ($this->Session->read('Auth.User.role')=='Admin')
