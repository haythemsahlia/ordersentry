...
<div class=" form" style="  width: 100%!important;    margin: 0 auto!important;padding-left: 0px;padding-top:0px;margin-top:0px;background-color:#f9f9f9;padding-right: 5px;">
...
<fieldset style=" float: left;">
   ...
   <h3  style="color:#367FA9;padding-top;10px!important;">Order <?php $def=""; if (isset ($id)/*||($id!=null)*/) {echo  $id.'</h1>'; $def=$id; } ?>
...
<tr><td width="28%"><label style="color:#2AB9E6;font-size: 15px;">Date</label><?php echo $this->Form->input('date' ,array('type'=>'text','label'=>'','disabled' => 'disabled','class'=>'datepicker','id'=>'datepicker', 'disabled' => 'disabled','style'=>';width:120px;', 'required'=>'required' ,'default'=> date('Y-m-d'),'onchange'=>'Verif();' ));;?></td>
<td width="22%"><label style="color:#2AB9E6;font-size: 15px;">Time</label><div style="float:left;" ><div style="float:left;">
<?php echo $this->Form->input('time' ,array('label'=>false ,'disabled' => 'disabled' ,'style'=>'width:90px; text-align:left;font-size:14px;font-weight:blod;margin-top:20px!important;' , 'required'=>'required', 'READONLY' => 'readonly'  ));;?></div></div></td>
...
<?php echo $this->Form->input('customername2' ,array('label'=>''  ,'disabled' => 'disabled','style'=>' text-align:left;font-size:15px;font-weight:blod;margin-top:20px!important;width:180px!important;' , 'placeholder'=>'customer second name' )); ?></td>
</tr>
</table><table style="border-collapse: separate;border-spacing: 10px; border:3px solid #929393">
<tr ><td ><?php echo $this->Form->input('instructionorder' ,array('type'=>'textarea','disabled' => 'disabled','label' => false,'placeholder'=>'Order Instructions ...','style'=>'  width: 300px!important;max-width: 616px!important;  height: 100px;background-color: white!important;font-size: 16px;' ));?></td>
</tr>
</table>
...
<fieldset style=" width:50%!important;float: left;">
      <!--   <h2 style="color:#367FA9;margin-top:10px;"> //echo __('Edit The Order '); </h2></br>-->
		<!-- <div style="margin-left:100px;width:400px;float:left"> -->
		<div style="margin-left: 0px;clear: both;padding-left: 5px;" id="myModal" >
...
<?php echo $this->Form->input('id' ,array('type'=>'hidden','disabled' => 'disabled','label'=>'','id'=>'id','disabled' => 'disabled','style'=>' ;margin-left:-2px;width:130px;background-color:#F2F2F2!important' ,'readonly'=>'true'));;?>
<table style="border-collapse: separate;border-spacing: 10px; border:3px solid #929393">
<tr><td width="28%"><label style="color:#2AB9E6;font-size: 15px;">Date</label><?php echo $this->Form->input('date' ,array('type'=>'text','disabled' => 'disabled','label'=>'','class'=>'datepicker','id'=>'datepicker','style'=>'font-size: 15px;width:150px;', 'required'=>'required' ,'default'=> date('Y-m-d'),'onchange'=>'Verif();' ));;?></td>
<td width="25%"><label style="color:#2AB9E6;font-size: 15px;">Time</label>
<div style="float:left;" ><div style="float:left;">
<?php echo $this->Form->input('time' ,array('label'=>'','disabled' => 'disabled','style'=>' text-align:left;font-size:15px;font-weight:blod;width:90px;' ,'id'=>'temps','onfocusout'=>'', 'required'=>'required'  ));;?></div>
</div></td>
<td width="25%" style=""><label style="color:#2AB9E6;font-size: 15px;">Customer Name</label> 
<?php //echo $this->Form->select('customer', $cust,array('label'=>'', 'required'=>'required' ,'style'=>'text-align:left;'   ));;?>
<?php echo $this->Form->input('customername' ,array('type'=>'text','disabled' => 'disabled','label' => false,'disabled' => 'disabled','style'=>'background-color: #F9F9F9!important;border:none!important;    height: 50px;border-bottom:none!important;font-size: 15px;padding-top:18px;' ));?>
</td><td width="22%" >
...
<?php echo $this->Form->input('instructionorder' ,array('type'=>'textarea','disabled' => 'disabled','label' => false,'placeholder'=>'Order Instructions ...','style'=>'      max-width: 330px!important;  height: 50px;background-color: white!important;font-size: 16px;margin-bottom:0px;' ));?>
</td>
<?php if($flagcust==1 ){?> 
<td>
<?php echo $this->Html->image('Flag-red-icon.png',array('id'=>'flag','disabled' => 'disabled', 'style'=>'margin-left:50px;"')) ;?>
</td>
<?php } ?>
...
// *******  Index PRODUCT *******************************
 ...
 if (isset ($id)) {$def=$id; } 
 ?>
<div style="width:45%!important;;float: left;margin-left:30px!important;">
...
<div class="panel panel-default">
    <div class="panel-body" style="  padding-top: 35px;padding-left: 0px;padding-right: 0px;margin-top:5px!important; ">
		...
		<th style="width:30%"><center>Item<?php  //echo $this->Paginator->sort('item', 'Item') ;?>  </center></th>
		<th style="width:25%;padding-left: 0px;padding-right: 0px;"><center>Quantity<?php  //echo $this->Paginator->sort('quantity', 'Quantity');?>  </center></th>
		<th style="width:45%"><center>Instructions<?php //echo $this->Paginator->sort('instructions', 'Instructions') ; ?> </center></th> 	
		...
		<?php endif; ?>
		 ...
		 <td class="productselect" style="width:30%;text-align: center;font-size: 130%;font-weight: bold;color:#1896df;" <?php echo 'prodid="'.$product["Product"]["id"].'" orderid="'.$def.'"'; ?>  >
      <?php  echo $items->ItemById(  $product['Product']['item'] ); ?>
     </td> 
		 <td class="productselect" style="width:25%;text-align: center;font-size: 130%;font-weight: bold;" ><?php echo  $product['Product']['quantity'] 	?> </td> 
		
		 <td class="productselect" style="min-height:39px!important;width:45%;text-align: center;font-size: 130%;font-weight: bold;" ><?php  echo $product['Product']['instructions'] 	 ?></td> 
  ...
  if ((currentproduct!=lastproduct) && (lastproduct != null))
  {
    $('.productselect:eq('+lastproduct+')').closest('tr').children('td,th')
     ...
     $('#'+previousselected).val(nsname);
	  ...
	  instr2=instr.substring(pinstr+3);
      $('#write').val(instr1);
      $('#write2').val(instr2);
	  }
	  else{
...
//window.location.href = "http://ordersentry.enterpriseesolutions.com/";
		vide=true;
