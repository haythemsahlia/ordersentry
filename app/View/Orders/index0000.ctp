...
<!-- 	 <script src="http://ordersentry.enterpriseesolutions.com/keyboard/js/jquery-migrate-3.0.0.min.js"></script> -->
 ...
 $customers = new CustomersController;
  // data[Order][date]
    ...
    // if date is set on filter
    if (isset($filterdate))
      {
        //echo "<h3>".$filterdate."</h3>";
        $dateorders = new OrdersController;
        /*
        $custt=$dateorders->ListeOrdersCustomerspecDate($filterdate);
        $custtph = array_column($custt, 0);
        print_r(array_keys($custt));*/
        //print_r($cust);
        /*******************************************************************************************/
        //$cust=$customers->ListeCustomers();
        $cust=$dateorders->ListeOrdersCustomerspecDate($filterdate);
...
<h1 class="no-print" style="color:#367FA9">All Orders </h1>
...
/*if ( (document.getElementById('OrderDate').value != "") && (document.getElementById('OrderDate').value != today) )
{
document.getElementById('OrderDate').value=today;
$('#Find').click();	
}*/
...
<?php echo $this->Form->create('Order',array('onsubmit'=>'show_alert();','class'=>'printform','controller'=>'orders','action'=>'printorders0')); ?>
    ...
    <div class="panel-body">
	 ...
	 <table id="myTable" class="table table-fixedheader table-bordered table-striped">
			...
			<th style="width:10%"><h4 style="margin-top:0px;"> <center><?php echo $this->Paginator->sort('id', 'ID');?>  </center></h4></th>
			 ...
			 <th style="width:19%"><h4 style="margin-top:0px;"> <center><?php echo $this->Paginator->sort('customer', 'Customer') ; ?></center></h4></th>
			 ...
			 <th style="padding-top:2px!important;width:8%;padding-left: 0px;padding-right: 1px;"><h4 style="font-size: 15px;margin-top:0px;padding-left: 0px;margin-left: 0px;"> <center>Edit/Add Products</center></h4></th>
...
//echo('date='.$date);
   ...
   if ($print){$style2="background-color:#70d1bd;color:black!important;font-weight:bold;";}else{$style2="";}		
      ...
      ?>
		...
		<td style="width:19%;text-align: center;<?php echo $style; ?>"> <h4 style="margin-top:5px;"><?php echo $order['Order']['customername'] ; 
   ...
   if ( ($sostatus != 2) && ( strtotime($order['Order']['date']) >=  strtotime($date) ) )
            ...
            //  echo substr($sotime,0,5) ;
             ...
             /* echo '<td style="width:15%;text-align: center;"> <h4 style="margin-top:5px;">';
              ...
              echo '</h4></td>'; */
              ?>
              <td style="width:19%;text-align: center;<?php echo $style; ?>"> <h4 style="margin-top:5px;"><?php echo $secondname; 
    //$this->Html->link( $order['Order']['customername']  ,   array('controller'=>'customers','action'=>'edit', $order['Order']['customer']),array('escape' => false) );
    ?></h4> </td>  
    <td style="width:15%;text-align: center;"> <h4 style="margin-top:5px;"><?php echo $order['Order']['customerphone'];?><!--hp echo $this->Html->link( ($order['Order']['customerphone'] ) ,   array('controller'=>'customers','action'=>'edit', $order['Order']['customer']),array('escape' => false) );?>--></h4> </td>
             <?php echo '<td style="width:12%;text-align: center;"> <h4 style="margin-top:5px;">';
