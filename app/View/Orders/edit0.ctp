<!-- echo $this->Html->css('jquery-ui');
	...
	<link href="http://oe1.enterpriseesolutions.com/keyboard/css/jquery-ui1.min.css" rel="stylesheet">
	...
	<link href="http://oe1.enterpriseesolutions.com/keyboard/css/keyboard.css" rel="stylesheet">
	<script src="http://oe1.enterpriseesolutions.com/keyboard/js/jquery.keyboard.js"></script>

	<!-- keyboard extensions (optional) Autocomplete -->
	<script src="http://oe1.enterpriseesolutions.com/keyboard/js/jquery.mousewheel.js"></script>
	<script src="http://oe1.enterpriseesolutions.com/keyboard/js/jquery.keyboard.extension-typing.js"></script>
	<script src="http://oe1.enterpriseesolutions.com/keyboard/js/jquery.keyboard.extension-autocomplete.js"></script>
	<script src="http://oe1.enterpriseesolutions.com/keyboard/js/jquery.keyboard.extension-caret.js"></script> 

	<!-- demo only 
	<link rel="stylesheet" href="http://oe1.enterpriseesolutions.com/keyboard/css/bootstrap.min.css">
	<link rel="stylesheet" href="http://oe1.enterpriseesolutions.com/keyboard/css/font-awesome.min.css">-->
 <!--	<link href="http://oe1.enterpriseesolutions.com/keyboard/css/demo.css" rel="stylesheet">-->
	<link href="http://oe1.enterpriseesolutions.com/keyboard/css/tipsy.css" rel="stylesheet">
	<link href="http://oe1.enterpriseesolutions.com/keyboard/css/prettify.css" rel="stylesheet">
	<script src="http://oe1.enterpriseesolutions.com/keyboard/js/bootstrap.min.js"></script>
	<!--<script src="http://oe1.enterpriseesolutions.com/keyboard/js/demo.js"></script>-->
	<script src="http://oe1.enterpriseesolutions.com/keyboard/js/jquery.tipsy.min.js"></script>
	<script src="http://oe1.enterpriseesolutions.com/keyboard/js/prettify.js"></script> <!-- syntax highlighting -->
	<!-- Style alerte window -->
...
<tr><td width="28%"><label style="color:#2AB9E6;font-size: 15px;">Date</label><?php echo $this->Form->input('date' ,array('type'=>'text','label'=>'','class'=>'datepicker','id'=>'datepicker', 'disabled' => 'disabled','style'=>';width:100px;', 'required'=>'required' ,'default'=> date('Y-m-d'),'onchange'=>'change(this);Verif();' ));;?></td>
<td width="22%"><label style="color:#2AB9E6;font-size: 15px;">Time</label><div style="float:left;" ><div style="float:left;">
<?php echo $this->Form->input('time' ,array('label'=>false   ,'onchange'=>'change(this);' ,'style'=>'width:75px; text-align:left;font-size:14px;font-weight:blod;margin-top:20px!important;' , 'required'=>'required', 'READONLY' => 'readonly'  ));;?></div></div></td>

<td width="28%"><label style="color:#2AB9E6;font-size: 15px;">Customer Name</label>
<?php echo $this->Form->input('customername',array('type'=>'text'  ,'onchange'=>'change(this);','label'=> false, 'required'=>'required' , 'disabled' => 'disabled','style'=>'background-color: #F9F9F9!important;font-size: 15px;border:none!important;    border-bottom:none!important;font-size: 15px;margin-top:20px!important;'   ));;?></td>
...
<?php echo $this->Form->input('customername2' ,array('label'=>''  ,'onchange'=>'change(this);','style'=>' text-align:left;font-size:15px;font-weight:blod;margin-top:20px!important;width:280px!important;' , 'placeholder'=>'customer second name' )); ?></td>
</tr>
</table><table style="border-collapse: separate;border-spacing: 10px; border:3px solid #929393">
<tr ><td ><?php echo $this->Form->input('instructionorder' ,array('type'=>'textarea'  ,'onchange'=>'change(this);','label' => false,'placeholder'=>'Order Instructions ...','style'=>'  width: 616px!important;max-width: 616px!important;  height: 100px;background-color: white!important;font-size: 16px;' ));?></td>
</tr>
</table>
  <?php     echo $this->Form->submit('Save', array('class' => 'form-submit', 'id'=>'idsave','style'=>'margin-bottom: 0px;margin-top:0px!important;margin-right:60px;margin-left: 262px;', 'title' => 'Clic here to edit the order    ') ); ?>
...
<?php echo $this->Form->input('id' ,array('type'=>'hidden','label'=>'','id'=>'id','style'=>' ;margin-left:-2px;width:130px;background-color:#F2F2F2!important' ,'readonly'=>'true'));;?>
<table style="border-collapse: separate;border-spacing: 10px; border:3px solid #929393">
<tr><td width="28%"><label style="color:#2AB9E6;font-size: 15px;">Date</label><?php echo $this->Form->input('date' ,array('type'=>'text','onchange'=>'change(this);','label'=>'','class'=>'datepicker','id'=>'datepicker','style'=>'font-size: 15px;width:100px;', 'required'=>'required' ,'default'=> date('Y-m-d'),'onchange'=>'change(this);Verif();' ));;?></td>
...
<?php echo $this->Form->input('customername' ,array('type'=>'text'  ,'onchange'=>'change(this);','label' => false,'disabled' => 'disabled','style'=>'background-color: #F9F9F9!important;border:none!important;    height: 50px;border-bottom:none!important;font-size: 15px;padding-top:18px;' ));?>
</td><td width="22%" >
<div style="float:left;"><label style="color:#2AB9E6;font-size: 15px;">Customer Phone</label> <?php echo $this->Form->input('customerphone' ,array('type'=>'text'  ,'onchange'=>'change(this);','label' => false,'disabled' => 'disabled','style'=>'    height: 50px;background-color: #F9F9F9!important;font-size: 15px;border:none!important;border-bottom:none!important;padding-top:18px;' ));?></div>
</td>
...
<?php echo $this->Form->input('instructionorder' ,array('type'=>'textarea'  ,'onchange'=>'change(this);','label' => false,'placeholder'=>'Order Instructions ...','style'=>'      max-width: 330px!important;  height: 50px;background-color: white!important;font-size: 16px;margin-bottom:0px;' ));?>
</td>
<?php if($flagcust==1 ){?> 
<td>
...
<div class="col-sm-6">
  ...
  <?php  		echo $this->Form->submit('Save', array('class' => 'form-submit', 'style'=>'margin-bottom: 0px;margin-top:0px!important;margin-right:60px;margin-left: 262px;', 'title' => 'Clic here to edit the order    ') ); ?>
...
<h3 class="no-print" style="color:#367FA9;padding-top:45px;">Products <?php $def=""; if (isset ($id)/*||($id!=null)*/) {echo 'of Order '. $id.'</h1>'; $def=$id; }else{echo 'of Orders</b</h3>'; $this->Filter->filterForm('Order', array('legend' => 'Recherche')); 
 } ?>
<!-- $this->Filter->filterForm('Order', array('legend' => 'Recherche')); -->
</div>
<!-- div to add for save and print -->
 <div style="float:left;">

  <?php 
        if ($orders->issuborder($id)){
        echo $this->Form->create('Order',array('controller'=>'orders','style'=>'position:relative;','action'=>'printorders0','id'=>'formm')); ?>
...
<?php echo $this->Form->input('id' ,array('type'=>'hidden','label'=>'','id'=>'id','style'=>' ;margin-left:-2px;width:130px;background-color:#F2F2F2!important' ,'readonly'=>'true'));;?>
<?php echo $this->Form->input('date' ,array('type'=>'hidden','label'=>'','class'=>'datepicker','id'=>'datepickern', 'disabled' => 'disabled','style'=>';width:100px;', 'required'=>'required' ,'default'=> date('Y-m-d'),'onchange'=>'Verif();' ));;?>

<?php echo $this->Form->input('time' ,array('type'=>'hidden','label'=>false  ,'id'=>'OrderTimen','style'=>'width:75px; text-align:left;font-size:14px;font-weight:blod;margin-top:20px!important;' , 'required'=>'required', 'READONLY' => 'readonly'  ));;?>

<?php echo $this->Form->input('customername',array('type'=>'hidden','id'=>'OrderCustomernamen','label'=> false, 'required'=>'required' , 'disabled' => 'disabled','style'=>'background-color: #F9F9F9!important;font-size: 15px;border:none!important;    border-bottom:none!important;font-size: 15px;margin-top:20px!important;'   ));;?></td>

<?php echo $this->Form->input('customername2' ,array('type'=>'hidden','label'=>''  ,'id'=>'OrderCustomername2n','style'=>' text-align:left;font-size:15px;font-weight:blod;margin-top:20px!important;width:280px!important;' , 'placeholder'=>'customer second name' )); ?>

<?php echo $this->Form->input('instructionorder' ,array('type'=>'hidden','id'=>'OrderInstructionordern','label' => false,'placeholder'=>'Order Instructions ...','style'=>'  width: 616px!important;max-width: 616px!important;  height: 100px;background-color: white!important;font-size: 16px;' ));?>
<?php echo $this->Form->submit('Save and print',array('class' => 'form-submit', 'style'=>'margin-left: 180%;background: orange!important;color:black!important;float:left;margin-top: 0px;','name'=>'Save and print','id'=>'saveprint')); ?>
...
<?php echo $this->Form->input('id' ,array('type'=>'hidden','label'=>'','id'=>'id','style'=>' ;margin-left:-2px;width:130px;background-color:#F2F2F2!important' ,'readonly'=>'true'));;?>
<?php echo $this->Form->input('date' ,array('type'=>'hidden','label'=>'','class'=>'datepicker','id'=>'datepickern','style'=>'font-size: 15px;width:100px;', 'required'=>'required' ,'default'=> date('Y-m-d'),'onchange'=>'Verif();' ));;?>

<?php echo $this->Form->input('time' ,array('type'=>'hidden','label'=>'','style'=>'display:none!important; text-align:left;font-size:15px;font-weight:blod;width:65px;' ,'id'=>'temps','onfocusout'=>'', 'required'=>'required'  ));;?>
<?php echo $this->Html->image('heure.png',array( 'id'=>'OrderTimen', 'style'=>'display:none!important; ')) ;?>

<?php echo $this->Form->input('customername' ,array('type'=>'hidden','id'=>'OrderCustomernamen','label' => false,'disabled' => 'disabled','style'=>'background-color: #F9F9F9!important;border:none!important;    height: 50px;border-bottom:none!important;font-size: 15px;padding-top:18px;' ));?>
 <?php echo $this->Form->input('customerphone' ,array('type'=>'hidden','label' => false,'disabled' => 'disabled','style'=>'    height: 50px;background-color: #F9F9F9!important;font-size: 15px;border:none!important;border-bottom:none!important;padding-top:18px;' ));?>

<?php echo $this->Form->input('instructionorder' ,array('type'=>'hidden','id'=>'OrderInstructionordern','label' => false,'placeholder'=>'Order Instructions ...','style'=>'      max-width: 330px!important;  height: 50px;background-color: white!important;font-size: 16px;margin-bottom:0px;' ));?>





  <?php echo $this->Form->submit('Save and print',array('class' => 'form-submit', 'style'=>'float:left;margin-top: 0px;margin-left: 180%;background: orange!important;color:black!important;','name'=>'Save and print','id'=>'saveprint')); ?>
...
if(x==1){
	...
	$("#myTable > tbody >#idtr").last().after("<tr id='idtr'><td  orderid='"+d+"' prodid='' onMouseOver='this.style.cursor="+codejs5+";'  onclick='prodselect(this);' class='productselect' style='width:25%;color:#428bca;text-align: center;font-size: 130%;font-weight: bold;'> "+codejs1+"</td><td style='width:20%;text-align: center;font-size: 130%;font-weight: bold;'>"+codejs2+"</td>	 <td style='width:40%;text-align: center;font-size: 130%;font-weight: bold;min-height:39px!important;'>"+codejs3+"</td> <td style='width:15%'><a onclick='return confirm("+conf+")' href='http://oe1.enterpriseesolutions.com/products/delete3/"+or+"/"+it+"/order'><center><img  style='height: 21px;min-width:18px!important;' src='/img/supp.png'> </img> </center></a></td></tr>");
		...
		//	$('#myTable > tbody > tr:first').before("<tr id='idtr'><td style='width:30%;color:#428bca;text-align: center;'><a href='http://oe1.enterpriseesolutions.com/products/edit3/"+or+"/"+it+"/order'>"+codejs1+"</a> </td> <td style='width:20%;text-align: center;'>"+codejs2+"</td>	 <td style='width:35%;text-align: center;'>"+codejs3+"</td> <td style='width:15%'><a onclick='return confirm("+conf+")' href='http://oe1.enterpriseesolutions.com/products/delete3/"+or+"/"+it+"/order'><center><img  style='min-width:18px!important;' src='/img/supp.png'> </img> </center></a></td></tr>");
...
//window.location.href = "http://oe1.enterpriseesolutions.com/";
		vide=true;
...
//modify
  ...
  function change(t){
	 // alert(t.id);
	  id=t.id;
	  value=t.value;
	  document.getElementById(id+'n').value=value;
