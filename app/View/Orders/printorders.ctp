...
if (isset($this->data['Order']['nbprint']))  {$nb=$this->data['Order']['nbprint'];}
if (isset($this->data['Order']['idtoprint'])){$ids=$this->data['Order']['idtoprint'];}
 $tab = array();

 for($i=0;$i < $nb; $i++){
$pos= strpos($ids, '/');
$tab[$i]=substr($ids,0,$pos);
...
<?php if($qul != "   "){
	$qu=$qty.'  '.$itemdesc.' - '.$qul;
		$qul1=str_replace('- -', '-', $qu);$qul1=str_replace('-  -', '-', $qu);$qul1=str_replace('-   -', '-', $qu);
 echo '<tr style="color:blue!important;"><td max-height="'.$width.'cm" colspan="3" style="color:blue!important;margin-bottom:0px!important;margin-top:0px!important;padding-bottom:0px!important;padding-top:0px!important;width:90%!important;font-size: 18px;font-family: serif;max-height:"'.$width.'cm!important;min-height:'.$width.'cm!important;"><p style="  font-size:14px;  margin-bottom: 0px!important;color:blue!important;font-weight:bold;margin-left: 10px;font-size: larger!important;">'.$qul1.'</p></td> </tr>'; }
else {
 echo '<tr style="color:blue!important;"><td max-height="'.$width.'cm" colspan="3" style="color:blue!important;margin-bottom:0px!important;margin-top:0px!important;padding-bottom:0px!important;padding-top:0px!important;width:90%!important;font-size: 18px;font-family: serif;max-height:'.$width.'cm!important;min-height:'.$width.'cm!important;"><p style="    margin-bottom: 0px!important;color:blue!important;font-weight:bold;margin-left: 10px;font-size: larger!important;">'.$qty.'  '.$itemdesc.'</p></td> </tr>';}
?>
		<?php endforeach; ?>
