...
<link href="http://ordersentry.enterpriseesolutions.com/keyboard/css/jquery-ui.min.css" rel="stylesheet">
	...
	<script src="http://ordersentry.enterpriseesolutions.com/keyboard/js/prettify.js"></script>  
...
{$custname=$this->data['form']['customername'];
$lastvaluename=$custname;
if  (isset( $this->data['form']['customerdate'])){$date=$this->data['form']['customerdate'];  
}
 
$LOrders=$products->ListeOrdersPerDateCustomername($date,$custname);
}
...
$LOrders=$products->ListeOrdersPerDateCustomernumname($date,$custnum,$custname);
}
