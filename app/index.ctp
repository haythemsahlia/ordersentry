    ...
    if (isset($filterdate))
      {
        ...
        $custfordate = $this->Order->find('list',array('fields'=>array('customername','customerphone'),'conditions'=>array('date'=>$filterdate))) ;
        //$custfordate['Order']['date'];
        print_r($custfordate);
      }
...
<h1 class="no-print" style="color:#367FA9">All Orders </h1><a  href="http://ordersentry.enterpriseesolutions.com/orders/add" ><img  id="add" style="float:right;margin-left:50px;" src="http://ordersentry.enterpriseesolutions.com/app/webroot/img/add.png"></img></a>
